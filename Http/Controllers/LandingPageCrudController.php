...
use Amplify\System\Cms\Http\Requests\LandingPageRequest;
use Amplify\System\Cms\Models\LandingPage;
 ...
 */
class LandingPageCrudController extends BackpackCustomCrudController
{
    ...
    {
        CRUD::setModel(LandingPage::class);
