...
class WidgetProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        $widgets = [
            ...
            \Amplify\System\Cms\Widgets\Menu\CategoryMenu::class => [
                'name' => 'menu.category-menu',
                'reserved' => true,
                'internal' => true,
                '@inside' => null,
                '@client' => null,
            ...
            \Amplify\System\Cms\Widgets\Menu\NestedMenu::class => [
                'name' => 'menu.nested-menu',
                'reserved' => true,
                'internal' => true,
                '@inside' => null,
                '@client' => null,
                    ...
                    [
                        ...
                        '@attributes' => [
                            ...
                            [
                                'name' => 'left-text',
                                'type' => 'text',
                                'value' => 'CUSTOMER SERVICE <br> NEW YORK: 1-800-3783650 <br> NEW ENGLAND: 1-800-3783650 <br>',
                            ],
                            [
                                'name' => 'right-icon',
                                'type' => 'text',
                            ...
                            [
                                'name' => 'right-text',
                                'type' => 'text',
                                'value' => 'RIVERHEAD BUILDING SUPPLY <br> HAS 19 LOCATION THROUGHOUT <br> LONG ISLAND AND NEW ENGLAND',
                            ],
                        ],
                        '@nestedItems' => [],
                    ],
                    ...
                    [
                        ...
                        '@attributes' => [
                            [
                                'name' => 'left-text',
                                'type' => 'text',
                                'value' => '© Company Name, All Rights Reserved',
                            ],
                            [
                                'name' => 'right-text',
                                'type' => 'text',
